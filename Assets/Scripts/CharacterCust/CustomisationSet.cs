...
public class CustomisationSet : MonoBehaviour
{
    ...
    public Vector2 scr;
    #endregion
    #region Example - Struct
    //[System.Serializable]
    //public struct MaterialTypeSetup
    //{
    //    public string name;
    ...
    //}
    //public MaterialTypeSetup[] matTypes = new MaterialTypeSetup[6];
    #endregion
    ...
    private void Start()
    {
        ...
        #endregion
        #region Example - Stuct load
        //foreach (var type in matTypes)
        //{
        //    OtherSetUpExample(type.maxLength,type.name,type.list);
        //}
        #endregion
    ...
    #region Example - Loop Function
    //void OtherSetUpExample(int max, string name, List<Texture2D> list)
    //{
    //    for (int i = 0; i < max; i++)
    //    {
    //        //creating a temp Texture2D that it grabs using Resources.Load from the Character File looking for Type_#
    //        Texture2D temp = Resources.Load("Character/"+ name + "_" + i) as Texture2D;
    //        //add our temp texture that we just found to the List
    //        list.Add(temp);
    //    }
    //}
    ...
    void SetTexture(string type, int dir)
    {
        ...
        switch (type)
        {
            ...
            #endregion
            default:
                Debug.Log("you forgot to put a valid type");
                break;
        }
        ...
        switch (type)
        {
            ...
            case "Armour":
                ...
                break;
            default:
                Debug.Log("Something went wrong in SetTexture second Switch");
                break;
        }
        #endregion
        Save();
    ...
    void Save()
    {
        ...
        TextAsset asset = Resources.Load("Save/CharacterSave.txt") as TextAsset;
    }
